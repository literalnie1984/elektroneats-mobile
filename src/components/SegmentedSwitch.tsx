		...
		return (
						...
						{props.segments.map((segment : string, index : number) => (
								<Pressable 
										...
										style={
												index === selectedSegment ? [defaultStyle.segment, props.segmentStyle, defaultStyle.selectedSegment, props.selectedSegmentStyle, { display: (props.isFolded == false ? "flex" : "none")}] : [defaultStyle.segment,props.segmentStyle,{ display: (props.isFolded == false ? "flex" : "none")}]
										}
								>
