    ...
    <View style={cartViewStyles.summary}>
      <View style={cartViewStyles.summaryInfo}>
        <Pressable style={cartViewStyles.summaryInfoHeader} onPress={props.summaryCollapseHandler}>
          ...
          <FontAwesomeIcon icon={props.isSummaryCollapsed ? faChevronDown : faChevronUp} color={cartViewStyles.summaryInfoHeaderIcon.color} size={cartViewStyles.summaryInfoHeaderIcon.width} />
        </Pressable>
  ...
  return (
    <View style={cartViewStyles.cartPanel}>
      <Pressable style={cartViewStyles.cartPanelHeader} onPress={props.panelExpansionHandler}>
        ...
        <FontAwesomeIcon icon={props.isPanelExpanded ? faChevronUp : faChevronDown} color={cartViewStyles.cartPanelHeaderIcon.color} size={cartViewStyles.cartPanelHeaderIcon.width} />
      </Pressable>
    </View>
  );
};
...
const CartView = () => {
  ...
  return (
    <View style={cartViewStyles.root}>
      <CartPanel isPanelExpanded={isPanelExpanded} panelExpansionHandler={() => setIsPanelExpanded(!isPanelExpanded)} />
      <CartPanelSummary summaryCollapseHandler={() => setIsSummaryCollapsed(!isSummaryCollapsed)} isSummaryCollapsed={isSummaryCollapsed} cartValue={21.37} cartPickupDate={"coś"} />
    </View>
  );
};
